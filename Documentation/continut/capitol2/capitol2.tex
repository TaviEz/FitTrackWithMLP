...
Where $f_i$ is the fat content of ingredient $i$ per gram. During testing, however,
this constraint caused the solver to return infeasible results for certain meal
compositions whose ingredient profiles could not simultaneously satisfy the fat
floor and the calorie and protein targets. To ensure the optimizer always produces
a valid solution regardless of meal structure, the fat constraint was relaxed and
the solver relies solely on the per-ingredient gram bounds to maintain realistic
portion sizes.
