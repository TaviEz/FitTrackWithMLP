...
A single inequality constraint enforces a minimum fat threshold:

\begin{equation}
\sum_{i=1}^{n} f_i x_i \ge F_{\text{min}}
\end{equation}

Where $f_i$ is the fat content of ingredient $i$ per gram. Additionally,
each decision variable is bounded by category-specific gram limits to ensure
